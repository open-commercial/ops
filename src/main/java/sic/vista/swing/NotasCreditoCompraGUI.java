...
public class NotasCreditoCompraGUI extends JInternalFrame {
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        try {
            ...
            this.cambiarEstadoDeComponentesSegunRolUsuario();
            this.setTitle("Administrar Notas de Credito Compra");
    ...
    private void btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EliminarActionPerformed
        if (tbl_Resultados.getSelectedRow() != -1) {
            int indexFilaSeleccionada = Utilidades.getSelectedRowModelIndice(tbl_Resultados);
            NotaCredito notaSeleccionada = notasTotal.get(indexFilaSeleccionada);
            if (notaSeleccionada.getIdFacturaCompra() != null) {
