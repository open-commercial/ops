...
public class NotasGUI extends JInternalFrame {
    ...
    public void buscarPorNroNota(long nroPedido) {
        chk_NumeroNota.setSelected(true);
        txt_NumeroNota.setEnabled(true);
        txt_NumeroNota.setText(String.valueOf(nroPedido));
        this.resetScroll();
        this.limpiarJTable();
        this.buscar(true); 
    }
    ...
    private String getUriCriteria() {
        ...
        if (chk_NumeroNota.isSelected()) {
            uriCriteria += "&nroPedido=" + Long.parseLong(txt_NumeroNota.getText());
        }
    ...
    private void cambiarEstadoEnabledComponentes(boolean status) {
        ...
        chk_NumeroNota.setEnabled(status);
        if (status == true && chk_NumeroNota.isSelected() == true) {
            txt_NumeroNota.setEnabled(true);
        } else {
            txt_NumeroNota.setEnabled(false);
        }
    ...
    private void cargarResultadosAlTable() {
        notasParcial.stream().map(factura -> {
        ...
        if (Desktop.isDesktopSupported()) {
            try {
                ...
                byte[] reporte = RestClient.getRestTemplate()
                        .getForObject("/facturas/" + notasTotal.get(indexFilaSeleccionada).getId_Factura() + "/reporte",
                                byte[].class);
    ...
    private void initComponents() {
        ...
        chk_NumeroNota = new javax.swing.JCheckBox();
        txt_NumeroNota = new javax.swing.JFormattedTextField();
        ...
        chk_NumeroNota.setText("Nº de Pedido:");
        chk_NumeroNota.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                chk_NumeroNotaItemStateChanged(evt);
            }
        });

        txt_NumeroNota.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        txt_NumeroNota.setText("0");
        txt_NumeroNota.setEnabled(false);
        txt_NumeroNota.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_NumeroNotaActionPerformed(evt);
            }
        });
        txt_NumeroNota.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_NumeroNotaKeyTyped(evt);
            }
        });
        ...
        subPanelFiltros2Layout.setHorizontalGroup(
            ...
            .addGroup(subPanelFiltros2Layout.createSequentialGroup()
                .addGroup(subPanelFiltros2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(chk_NumeroNota, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(subPanelFiltros2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_NumeroNota, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        subPanelFiltros2Layout.setVerticalGroup(
            ...
            .addGroup(subPanelFiltros2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(subPanelFiltros2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(chk_NumeroNota, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_NumeroNota, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(0, 0, Short.MAX_VALUE))
        );
        ...
        if (tbl_Resultados.getSelectedRow() != -1) {
            ...
            if (respuesta == JOptionPane.YES_OPTION) {
                ...
                for (int indice : indexFilasSeleccionadas) {
                    idsFacturas[i] = notasTotal.get(indice).getId_Factura();
                    i++;
                }
                try {
    ...
    private void txt_NumeroNotaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_NumeroNotaKeyTyped
        Utilidades.controlarEntradaSoloNumerico(evt);
    }//GEN-LAST:event_txt_NumeroNotaKeyTyped

    private void chk_NumeroNotaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chk_NumeroNotaItemStateChanged
        txt_NumeroNota.setEnabled(chk_NumeroNota.isSelected());
    }//GEN-LAST:event_chk_NumeroNotaItemStateChanged
        ...
        try {
            ...
            if (FEHabilitada) {
                if (tbl_Resultados.getSelectedRow() != -1 && tbl_Resultados.getSelectedRowCount() == 1) {
                    int indexFilaSeleccionada = Utilidades.getSelectedRowModelIndice(tbl_Resultados);
                    long idFacturaSeleccionada = notasTotal.get(indexFilaSeleccionada).getId_Factura();
    ...
    private void txt_NumeroNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_NumeroNotaActionPerformed
        btn_BuscarActionPerformed(null);
    }//GEN-LAST:event_txt_NumeroNotaActionPerformed
    ...
    private javax.swing.JCheckBox chk_NumeroNota;
    ...
    private javax.swing.JFormattedTextField txt_NumeroNota;
