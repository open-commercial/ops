...
public class DetalleTransportistaGUI extends JDialog {
    ...
    private void initComponents() {
        ...
        panelPrincipalLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btnUbicacion, lblDetalleUbicacionTransportista});
	...
	private void btn_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_GuardarActionPerformed
            try {
                if (operacion == TipoDeOperacion.ALTA) {
                    ...
                    transportista.setIdEmpresa(EmpresaActiva.getInstance().getEmpresa().getIdEmpresa());
                ...
                if (operacion == TipoDeOperacion.ACTUALIZACION) {
                    ...
                    transportistaModificar.setIdEmpresa(EmpresaActiva.getInstance().getEmpresa().getIdEmpresa());
                    transportistaModificar.setIdEmpresa(EmpresaActiva.getInstance().getEmpresa().getIdEmpresa());
                    if (this.ubicacion != null) {
